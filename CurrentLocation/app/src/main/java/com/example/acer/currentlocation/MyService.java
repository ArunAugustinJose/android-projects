...
public class MyService extends Service
{
    ...
    private class LocationListener implements android.location.LocationListener
    {
        ...
        public void onLocationChanged(Location location)
        {
            ...
            myRef =database.getReference(uid).child("MyLocation");
            myRef2 =database.getReference(uid).child("TravelLocation").child(mydate+" "+addresses.get(0).getAddressLine(0));
            addloc loc = new addloc(location.getLatitude(),location.getLongitude());
            myRef.setValue(loc);
            myRef2.setValue(loc);
    ...
    public int onStartCommand(Intent intent, int flags, int startId)
    {
        ...
        uid=session.getValue(MyService.this,"uid");
