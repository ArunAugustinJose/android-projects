    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backbt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in=new Intent(com.example.acer.nsample2.Login.OtpVerificationActivity.this, PhoneNumberActivity.class);
                startActivity(in);
            }
        });
                ...
                new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                    ...
                    public void onVerificationFailed(FirebaseException e) {
                        ...
                        if (e instanceof FirebaseAuthInvalidCredentialsException) {
                            // Invalid request
                            Toast.makeText(com.example.acer.nsample2.Login.OtpVerificationActivity.this,"Invalid credantials",Toast.LENGTH_LONG).show();
...
//                            OtpVerificationActivity.this.finish();
    ...
    private void showDiag() {
        ...
        new CountDownTimer(1500, 1000) { // adjust the milli seconds here
            ...
            public void onFinish() {
                Intent in=new Intent(com.example.acer.nsample2.Login.OtpVerificationActivity.this, MapsActivity.class);
                startActivity(in);
                com.example.acer.nsample2.Login.OtpVerificationActivity.this.finish();
            }
        }.start();
